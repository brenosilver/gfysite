...
var gfyCollection = function () {
    ...
    function init() {
        ...
        for (var i = 0; i < elem_coll.length; i++) {
			console.log("item id: " + elem_coll[i].getAttribute("data-id")) //////////////////////////////////////////////////////////////////////
...
var gfyObject = function (gfyElem) {
    ...
    function setWrapper() {
		gfyRootElem.className = "item opacity";
		gfyRootElem.setAttribute("data-gfyid", gfyId);
		gfyRootElem.setAttribute("data-toggled", "off");
        gfyRootElem.style.position = "relative";
        gfyRootElem.style.padding = 0;
        if (!optExpand) {
            gfyRootElem.style.display = 'inline-block';
			//gfyRootElem.style.visibility = 'hidden'; ///////////////////// remove this line
